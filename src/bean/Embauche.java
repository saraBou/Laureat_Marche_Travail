...
@Entity
   ...
   private Laureat laureat;
    ...
    public Embauche(Societe societe, Date dateDembauche, Date dateDeFin, int salaireMax, int salaireMin) {
    ...
    public String toString() {
        return "Embauche{" + "id=" + id + ", societe=" + societe + ", dateDembauche=" + dateDembauche + ", dateDeFin=" + dateDeFin + ", salaireMax=" + salaireMax + ", salaireMin=" + salaireMin + ", secteurActivite=" + secteurActivite + ", laureat=" + laureat + '}';
    }
